  ...
  <div class="container-fluid">
    <div class="row">
      <div class="card">
        ...
        <form action="{{route('admin.create-event-story')}}" method="POST" enctype="multipart/form-data" class="p-3">
          ...
          <div class="row clearfix">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8">
              <div class="form-group">
                <input type="text" name="eventtitle" id="event-title" placeholder="Enter event title" class="form-control" aria-required="true" aria-invalid="false">
              </div>
            </div>
          </div>
          ...
          <div class="row clearfix">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8">
              <div class="form-group">
                <textarea type="text" name="eventdescription" id="event-description" placeholder="Enter event description" class="form-control" aria-required="true" aria-invalid="false" rows="4"></textarea>
              </div>
            </div>
          </div>
          <!-- event category -->
          <div class="row clearfix">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8">
              <div class="form-group">
                <select class="custom-select form-control" id="event-category" name="eventcategory" aria-required="true" aria-invalid="false">
          ...
          <div class="row clearfix">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8 d-flex justify-content-between">
              ...
              <div class="col-lg-4 col-md-4 col-sm-8 ml-0 ">
                ...
                <div class="form-group">
                  <input type="date" name="startdate" id="startdate" placeholder="Date event starts" class="form-control" aria-required="true" aria-selected="current" aria-invalid="false">
                </div>
              </div>
              <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
              ...
              <div class="col-lg-4 col-md-4 col-sm-8 pl-0 ml-0">
                <span class="small text-danger" style="display: none;"></span>
                <div class="form-group">
                  <input type="date" name="enddate" id="enddate" placeholder="Date event ends" class="form-control" aria-required="true"  aria-invalid="false">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row clearfix">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8">
              <div class="form-group">
                <select class="custom-select form-control" id="event-type" name="eventtype" aria-required="true" aria-invalid="false">
          ...
          <div class="row clearfix text-center">
            <div class="col-sm-8 offset-sm-2"><button type="submit" class="btn buttons btn-raised btn-primary btn-round waves-effect">Create Event</button></div>
          </div>
        </form>
      </div>
    </div>
